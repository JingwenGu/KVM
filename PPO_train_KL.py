env_choice = 'id'
model_choice = 'gpt2'
log = 'trained_checkpoints/log_kl_1213_id-1.txt'
save_path = 'trained_ppl_checkpoints/ID_kl_1213_1'
total_steps = 1500000
lr = 3e-4
ent_coef = 0.01
...
gym.register(id='EnvKLID', entry_point='Env_KL_ID:Env_KL_ID')
env_kwargs = {
...
if env_choice == 'kv':
    ...
    kv_vec_env_1 = make_vec_env('EnvKLID', n_envs=1, env_kwargs=env_kwargs)
    kv_vec_env_train = make_vec_env('EnvKLID', n_envs=1, env_kwargs=env_kwargs)
