...
class Env_KL_ID(gym.Env):
    ...
    def step(self,action):
        ...
        reward = self.KL_reward(logits,true_outputs.logits,temperature=2.0).item()
        print(reward)
    ...
    def KL_reward(self,student_logits, teacher_logits, temperature):
